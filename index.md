...
My research interests lie in tackling large-scale, data-driven societal problems, particularly in the field of healthcare.  My toolbox includes linear and mixed-integer optimization, inverse optimization, decision diagrams, heuristics and efficient algorithms, with a background in interface design. The goal of my work is bringing these solutions back out of theory to the end users and decision-makers. 
