...
My research interests lie in tackling large-scale, data-driven societal problems, particularly in the field of healthcare.  My toolbox includes linear and mixed-integer optimization, inverse optimization, decision diagrams, heuristics and efficient algorithms, with a background in interface design. The goal of my work is to not only propose solutions, but to then bring these solutions back out of theory to the end users, decision-makers and the community at large. 
...
Whether it relates to public health, individual systems or fundamental algorithmic math, my emphasis lies in communication, illustration and teaching for the broader community. 
